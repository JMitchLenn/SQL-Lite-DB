...
### get an export to excel button
### get an update/delete button working
### add the segment ie student mentor etc
### button to id mentors based on age
### add in rest of data
### fix the style thing
### bulk load info upload from excel
### chop out the stuff that is not needed
...
class Main(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Hackathon Master")
    ...
    def toolBar(self):
        ...
        #####################Toolbar Buttons############
        ####################Add Product################
        self.addProduct=QAction(QIcon('icons/add.png'),"Add Participant",self)
        self.tb.addAction(self.addProduct)
        self.addProduct.triggered.connect(self.funcAddProduct)
        self.tb.addSeparator()
        ######################Add Member################
        self.addMember=QAction(QIcon('icons/users.png'),"Add Administrator",self)
        self.tb.addAction(self.addMember)
        self.addMember.triggered.connect(self.funcAddMember)
        self.tb.addSeparator()
        ######################Sell Products###############
        self.sellProduct = QAction(QIcon('icons/users.png'),"This Will be Deleted",self)
    ...
    def tabWigdet(self):
        ...
        self.tab2=QWidget()
        self.tab3=QWidget()
        self.tabs.addTab(self.tab1,"Participants")
        self.tabs.addTab(self.tab2,"Administrators")
    ...
    def widgets(self):
        ...
        self.productsTable.setHorizontalHeaderItem(1,QTableWidgetItem("Email"))
        self.productsTable.setHorizontalHeaderItem(2,QTableWidgetItem("First Name"))
        self.productsTable.setHorizontalHeaderItem(3,QTableWidgetItem("Last Name"))
        self.productsTable.setHorizontalHeaderItem(4,QTableWidgetItem("Grade"))
        self.productsTable.setHorizontalHeaderItem(5,QTableWidgetItem("Gender"))
        self.productsTable.setHorizontalHeaderItem(6, QTableWidgetItem("Organization"))
        self.productsTable.setHorizontalHeaderItem(7, QTableWidgetItem("Address"))
        #self.productsTable.horizontalHeader().setSectionResizeMode(1,QHeaderView.Stretch)
        self.productsTable.horizontalHeader().setSectionResizeMode(1,QHeaderView.ResizeToContents)
        ...
        self.productsTable.horizontalHeader().setSectionResizeMode(7, QHeaderView.ResizeToContents)
        ...
        self.searchEntry.setPlaceholderText("Search For Participants")
    ...
    def layouts(self):
        ...
        self.statisticsLayout.addRow("Total Particpants:",self.totalProductsLabel)
    ...
    def displayProducts(self):
        ...
        query = cur.execute("SELECT * FROM master")
    ...
    def displayMembers(self):
        ...
        members = cur.execute("SELECT * FROM master")
    ...
    def getStatistics(self):
        ...
        countProducts = cur.execute("SELECT count(PersID) FROM master").fetchall()
        countMembers = cur.execute("SELECT count(PersID) FROM master").fetchall()
        soldProducts = cur.execute("SELECT count(PersID) FROM master").fetchall()
        totalAmount = cur.execute("SELECT count(PersID) FROM master").fetchall()
